    ...
    >
      <PuzzleCard accent={accent} status={project.status} active={running} className="h-full">
        <div
          ...
          role="button"
          tabIndex={0}
          className="flex flex-col h-full w-full text-left cursor-pointer"
          style={{ "--area": accent }}
        >
          {/* Cabecera visual */}
            ...
            <div className="mt-auto space-y-3">
              ...
              {onEdit && (
                <button
                  ...
                  className="ui-cta group w-full inline-flex items-center justify-center gap-1.5 bg-primary text-primary-foreground px-4 py-2 rounded-md text-sm font-medium piece-cut"
                >
